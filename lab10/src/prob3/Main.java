...
public class Main {
	...
	public static <T> boolean contains3(List<? extends T> list, T e, BiPredicate<? super T, ? super T> pred2) {
		for (T item : list) {
			if (item == null && e == null)
				return true;
			if (item == null || e == null)
				continue;
			if (pred2.test(item, e))
				return true;
		}
		return false;
	}
	...
	public static void test2() {
		...
		boolean foundIt = Main.contains3(list, e, (e1, e2) -> e1.getId() == e2.getId());
	...
	public static void test5() {
		...
		boolean foundIt = Main.contains3(list, a, (Account a1, Account a2) -> a1.getAcctId() == a2.getAcctId());
		System.out.println(foundIt);
	}
